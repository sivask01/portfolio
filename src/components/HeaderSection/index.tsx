      ...
      <div className="flex justify-between items-center gap-x-2 gap-y-8 lg:flex-row flex-col">
        <div className={`lg:basis-3/5 flex flex-col gap-3 md:basis-auto`}>
          ...
          >
            ...
            <div className="flex flex-row flex-wrap gap-2">
              ...
              <TypingText textArr={["Backend Developer", "AI Engineer", "Data Scientist", "AWS Developer"]} />
            </div>
            <AppText textTag="p" medium defaultColor customClass="mt-4 mb-4">
              {`I thrive in roles where I can blend my love for Software Systems and AI with my knack for developing practical solutions. As a dedicated problem-solver and innovator, I'm always eager to tackle new challenges and drive impactful outcomes.`}
            </AppText>
            <ContactLogos />
          </div>
          <div className="flex items-center justify-start gap-4 mt-6 flex-wrap">
            ...
            <AppButton
              ...
              onClick={() => {
                window.open("https://drive.google.com/file/d/1gqF4aQGCRp8vGl5uWaODmjKixbUR2JzN/view?usp=sharing", '_blank');
              }}
        ...
        <div className="lg:basis-2/5 md:basis-auto">
          <div className="md:w-[250px] md:h-[600px] sm:h-[75vw] sm:w-[40vw] h-[120vw] w-[50vw] relative m-auto">
            <Image
              alt="Sivakrishna's Avatar Image"
